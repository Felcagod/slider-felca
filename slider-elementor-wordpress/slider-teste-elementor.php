<?php
/*
 * Plugin Name: Slider Simples(para wordpress)
 * Author:None
 * Description:Sliders simples
 * Author:Wagner .P
 * Version:0.1
 * 
 * 
...
function fwrsw_responsive_full_width_slider_add_admin_menu() {
	...
	$hook_suffix = add_menu_page ( __( 'Sliders teste','full-width-responsive-slider-wp') , __ ( 'Teste de plugin de slider','full-width-responsive-slider-wp' ), 'fwrsw_responsive_full_width_slider_settings', 'responsive_full_width_slider_wp', 'fwrsw_responsive_full_width_slider_wp_admin_options_func' );
	$hook_suffix=add_submenu_page ( 'responsive_full_width_slider_wp', __ ( 'Configuracao de sliders','full-width-responsive-slider-wp' ), __ ( 'Configuracao de sliders','full-width-responsive-slider-wp' ), 'fwrsw_responsive_full_width_slider_settings', 'responsive_full_width_slider_wp', 'fwrsw_responsive_full_width_slider_wp_admin_options_func' );
	$hook_suffix_image=add_submenu_page ( 'responsive_full_width_slider_wp', __ ( 'Gerenciar imagens','full-width-responsive-slider-wp' ), __ ( 'Gerenciamento de imagens','full-width-responsive-slider-wp' ), 'fwrsw_responsive_full_width_slider_view_images', 'responsive_full_width_slider_wp_media_management', 'fwrsw_responsive_full_width_slider_wp_media_management_func' );
	$hook_suffix_prev=add_submenu_page ( 'responsive_full_width_slider_wp', __ ( 'pre-visualizacao dos sliders','full-width-responsive-slider-wp' ), __ ( 'pre-visualizacao de imagens','full-width-responsive-slider-wp' ), 'fwrsw_responsive_full_width_slider_preview', 'responsive_full_width_slider_wp_media_preview', 'fwrsw_responsive_full_width_slider_wp_media_preview_func' );
...
function fwrsw_responsive_full_width_slider_wp_admin_options_func(){
        ...
        if(isset($_POST['btnsave'])){
            ...
            $fwrsw_full_width_slider_msg['message']=__("Configuracoes salvas com sucesso",'full-width-responsive-slider-wp');
    ...
    <div style="width: 100%;">  
        <div style="float:left;width:100%;">
            <div class="wrap">
                ...
                <h2><?php echo __("Configuracao de sliders",'full-width-responsive-slider-wp');?></h2>
                <div id="poststuff">   
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content" >
                                <form method="post" action="" id="scrollersettiings" name="scrollersettiings" >
                                    <div class="stuffbox" id="namediv" style="width:100%;">
                                        <h3><label for="link_name"><?php echo __("Configuracoes",'full-width-responsive-slider-wp');?></label></h3>
                                        <table cellspacing="0" class="form-list" cellpadding="10">
                                            <tbody>
                                              
                                                <tr>
                                                    <td class="label">
                                                        <label for="slider_Speed"><?php echo __("Velocidade do slider",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="height"><?php echo __("Altura do slider",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="height_tablets"><?php echo __("Tablets de altura deslizante",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="height_sphone"><?php echo __("Smartphone com altura deslizante",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="slider_Drag"><?php echo __("Permitir arrastar no controle deslizante",'full-width-responsive-slider-wp');?>  <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                        <select id="slider_Drag" name="slider_Drag" class="select">
                                                            <option value=""><?php echo __("Selecionar",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Drag'])==1):?> selected="selected" <?php endif;?>  value="1" ><?php echo __("Sim",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Drag'])==0):?> selected="selected" <?php endif;?>  value="0"><?php echo __("Nao",'full-width-responsive-slider-wp');?></option>
                                                        </select>            
                                                        <div style="clear:both"></div>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="slider_Dots"><?php echo __("Mostrar paginação do controle deslizante",'full-width-responsive-slider-wp');?>  <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                        <select id="slider_Dots" name="slider_Dots" class="select">
                                                            <option value=""><?php echo __("Selecionar",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Dots'])==1):?> selected="selected" <?php endif;?>  value="1" ><?php echo __("Sim",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Dots'])==0):?> selected="selected" <?php endif;?>  value="0"><?php echo __("Nao",'full-width-responsive-slider-wp');?></option>
                                                        </select>            
                                                        <div style="clear:both"></div>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="slider_Dots_prev"><?php echo __("Mostrar visualizacao ao passar o mouse",'full-width-responsive-slider-wp');?>  <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="slider_Arrows"><?php echo __("Mostrar setas",'full-width-responsive-slider-wp');?>  <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                        <select id="slider_Arrows" name="slider_Arrows" class="select">
                                                            <option value=""><?php echo __("Selecionar",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Arrows'])==1):?> selected="selected" <?php endif;?>  value="1" ><?php echo __("Sim",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['slider_Arrows'])==0):?> selected="selected" <?php endif;?>  value="0"><?php echo __("Nao",'full-width-responsive-slider-wp');?></option>
                                                        </select>            
                                                        <div style="clear:both"></div>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        <label for="auto_slide"><?php echo __("Slider automatico",'full-width-responsive-slider-wp');?>  <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                        <select id="auto_slide" name="auto_slide" class="select">
                                                            <option value=""><?php echo __("Selecionar",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['auto_slide'])==1):?> selected="selected" <?php endif;?>  value="1" ><?php echo __("Sim",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['auto_slide'])==0):?> selected="selected" <?php endif;?>  value="0"><?php echo __("Nao",'full-width-responsive-slider-wp');?></option>
                                                        </select>            
                                                        <div style="clear:both"></div>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <tr id="auto_slide_interval_" style="display:none">
                                                    <td class="label">
                                                        <label for="auto_slide_interval"><?php echo __("Intervalo de slide automático",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                ...
                                                <tr id="allow_btrans" >
                                                    <td class="label">
                                                        <label for="allow_btrans"><?php echo __("Mostrar transicao negra",'full-width-responsive-slider-wp');?> <span class="required">*</span></label>
                                                    </td>
                                                    <td class="value">
                                                        
                                                        <select id="allow_btrans" name="allow_btrans" class="select">
                                                            <option value=""><?php echo __("Selecionar",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['allow_btrans'])==1):?> selected="selected" <?php endif;?>  value="1" ><?php echo __("Sim",'full-width-responsive-slider-wp');?></option>
                                                            <option <?php if(intval($settings['allow_btrans'])==0):?> selected="selected" <?php endif;?>  value="0"><?php echo __("Nao",'full-width-responsive-slider-wp');?></option>
                                                        </select>            
                                                        <div style="clear:both"></div>
                                                        <div></div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="label">
                                                        ...
                                                        <input type="submit"  name="btnsave" id="btnsave" value="<?php echo __("Salvar configuracoes",'full-width-responsive-slider-wp');?>" class="button-primary">    
...
function fwrsw_responsive_full_width_slider_wp_media_management_func() {
	...
	if (strtolower ( $action ) == strtolower ( 'gridview' )) {
		...
		?>
				...
				<h2>
					<?php echo __('Imagens','full-width-responsive-slider-wp');?><a class="button add-new-h2" href="admin.php?page=responsive_full_width_slider_wp_media_management&action=addedit"><?php echo __('Adicionar imagem','full-width-responsive-slider-wp');?></a>
                                        &nbsp;&nbsp;
                                        <a class="massAdd button add-new-h2" href="javascript:void(0)"><?php echo __('Adicionar em massa','full-width-responsive-slider-wp');?></a>
				</h2>
				<br />
				...
				<form method="POST"
					...
					<div class="alignleft actions">
						<select name="action_upper" id="action_upper">
							<option selected="selected" value="-1"><?php echo __('Acao em massa','full-width-responsive-slider-wp');?></option>
							<option value="delete"><?php echo __('deletar','full-width-responsive-slider-wp');?></option>
						</select> <input type="submit" value="<?php echo __('Aplicar','full-width-responsive-slider-wp');?>"
					...
					<br class="clear">
							...
							?>
                                            ...
                                            <div style="padding-top:5px;padding-bottom:5px">
                                                <b><?php echo __( 'procurar','full-width-responsive-slider-wp');?> : </b>
                                                  <input type="text" value="<?php echo $seval;?>" id="search_term" name="search_term">&nbsp;
                                                  <input type='button'  value='<?php echo __( 'procurar','full-width-responsive-slider-wp');?>' name='searchusrsubmit' class='button-primary' id='searchusrsubmit' onclick="SearchredirectTO();" >&nbsp;
                                                  <input type='button'  value='<?php echo __( 'resetar busca','full-width-responsive-slider-wp');?>' name='searchreset' class='button-primary' id='searchreset' onclick="ResetSearch();" >
                                            </div>  
                                            <script type="text/javascript" >
									...
									<th class="manage-column column-cb check-column" scope="col"><input type="checkbox"></th>
									 <?php if($order_by=="id" and $order_pos=="asc"):?>
                                                                        ...
                                                                        <?php if($order_by=="title" and $order_pos=="asc"):?>
                                                                             ...
                                                                             <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Titulo','full-width-responsive-slider-wp');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                                                                        <?php else:?>
                                                                            <?php if($order_by=="title"):?>
                                                                        <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Titulo','full-width-responsive-slider-wp');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                                                                            <?php else:?>
                                                                                <th><a href="<?php echo $setacrionpage;?>&order_by=title&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Titulo','full-width-responsive-slider-wp');?></a></th>
                                                                            <?php endif;?>    
                                                                        <?php endif;?>  
									<th><span></span></th>
									  ...
									  <?php if($order_by=="createdon" and $order_pos=="asc"):?>
                                                                            ...
                                                                            <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Publicada em','full-width-responsive-slider-wp');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                                                                            <?php else:?>
                                                                                <?php if($order_by=="createdon"):?>
                                                                            <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Publicada em','full-width-responsive-slider-wp');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                                                                                <?php else:?>
                                                                                    <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Publicada em','full-width-responsive-slider-wp');?></a></th>
                                                                                <?php endif;?>    
                                                                            <?php endif;?>  
								                         
									
									<th><span><?php echo __('editar','full-width-responsive-slider-wp');?></span></th>
									<th><span><?php echo __('deletar','full-width-responsive-slider-wp');?></span></th>
								</tr>
							</thead>
									...
									foreach($rows as $row) {
										...
										?>
                                                                        <tr valign="top">
                                                                            ...
                                                                            <td data-title="<?php echo __('publicada em','full-width-responsive-slider-wp');?>" class="alignCenter"><?php echo esc_html($row['createdon']); ?></td>
                                                                            <td data-title="<?php echo __('editar','full-width-responsive-slider-wp');?>" class="alignCenter"><strong><a href='<?php echo esc_url($editlink); ?>' title="<?php echo __('Edit','full-width-responsive-slider-wp');?>"><?php echo __('Edit','full-width-responsive-slider-wp');?></a></strong></td>
                                                                            <td data-title="<?php echo __('deletar','full-width-responsive-slider-wp');?>" class="alignCenter"><strong><a href='<?php echo esc_url($deletelink); ?>' onclick="return confirmDelete();" title="<?php echo __('Delete','full-width-responsive-slider-wp');?>"><?php echo __('Delete','full-width-responsive-slider-wp');?></a> </strong></td>
                                                                    </tr>
                                                                    <?php
                                                                            }
                                                                    } else {
                                                                    ...
                                                                    <tr valign="top" class=""
                                                                            id="">
                                                                            <td colspan="9" data-title="<?php echo __('nao ha registros','full-width-responsive-slider-wp');?>" align="center"><strong><?php echo __('No Images','full-width-responsive-slider-wp');?></strong></td>
                                                                    </tr>
                                                                 <?php
								}
								?>      
					...
					<div class="alignleft actions">
						<select name="action" id="action_bottom">
							<option selected="selected" value="-1"><?php echo __('acoes em massa','full-width-responsive-slider-wp');?></option>
							<option value="delete"><?php echo __('Delete','full-width-responsive-slider-wp');?></option>
                                               ...
                                               <?php wp_nonce_field('action_settings_mass_delete', 'mass_delete_nonce'); ?>
                                                <input type="submit" value="<?php echo __('aplicar','full-width-responsive-slider-wp');?>"
							class="button-secondary action" id="deleteselected"
							name="deleteselected" onclick="return confirmDelete_bulk();">
					</div>
				...
				<script type="text/JavaScript">
                                        ...
                                        function  confirmDelete_bulk(){
                                                        ...
                                                        if(topval=='delete' || bottomVal=='delete'){
                                                            ...
                                                            var agree=confirm("<?php echo __('voce tem certezxa que quer deletar essa imagem?','full-width-responsive-slider-wp');?>");
                                                            if (agree)
                                                                return true ;
                                                            else
                                                                return false;
                                        ...
                                        function  confirmDelete(){
                                         var agree=confirm("<?php echo __('voce tem certeza que quer deletar esta imagem ?','full-width-responsive-slider-wp');?>");
                                         if (agree)
                                             return true ;
                                        else
                                            return false;
                                    ...
                                    jQuery(document).ready(function() {
                                           ...
                                           jQuery(".massAdd").click(function(event) {
                                              ...
                                              custom_file_frame = wp.media.frames.customHeader = wp.media({
                                                 ...
                                                 title: "<?php echo __("WP media upload",'full-width-responsive-slider-wp');?>",
                                                 library: {
                                                    type: 'image'
                                                 },
                                                 button: {
                                                    //Button text
                                                    text: "<?php echo __("definir imagem",'full-width-responsive-slider-wp');?>"
                                                 },
		...
		<h3><?php echo __('para imprimir este controle deslizante de largura total na postagem/pagina do wordPress use o codigo abaixo','full-width-responsive-slider-wp');?></h3>
		<input type="text"
			value='[fwrsw_print_responsive_full_width_slider_wp] '
			style="width: 400px; height: 30px"
			onclick="this.focus(); this.select()" />
		<div class="clear"></div>
		<h3><?php echo __('para imprimir este controle deslizante de largura total em arquivos php de tema/modelo do wordpress, use o codigo abaixo','full-width-responsive-slider-wp');?></h3>
                <?php
		...
		if (isset ( $_POST ['btnsave'] )) {
			...
			if (isset ( $_POST ['imageid'] )) {
				...
				try {
					...
					$fwrsw_full_width_slider_msg = array ();
					$fwrsw_full_width_slider_msg ['type'] = 'succ';
					$fwrsw_full_width_slider_msg ['message'] = __('nova imagem adicionada com sucesso','full-width-responsive-slider-wp');
					update_option ( 'fwrsw_full_width_slider_msg', $fwrsw_full_width_slider_msg );
				} 
                                catch ( Exception $e ) {
					...
					$fwrsw_full_width_slider_msg = array ();
					$fwrsw_full_width_slider_msg ['type'] = 'err';
					$fwrsw_full_width_slider_msg ['message'] = __('erro enquanto carrega a imagens','full-width-responsive-slider-wp');
					update_option ( 'fwrsw_full_width_slider_msg', $fwrsw_full_width_slider_msg );
				}
         ...
         <div style="float: left; width: 100%;">
	       <div class="wrap">
	    	...
	    	<?php
				...
				?>
	         <h2><?php echo __('update na imagem ','full-width-responsive-slider-wp');?></h2><?php
			} else {
				...
				?>
                 <h2><?php echo __('Adicionar imagem','full-width-responsive-slider-wp');?></h2>
                   <?php } ?>
                   <br />
					<div id="poststuff">
						<div id="post-body" class="metabox-holder columns-2">
							<div id="post-body-content">
										...
										<h3>
											<label for="link_name"><?php echo __('infomacao da imagem','full-width-responsive-slider-wp');?></label>
										</h3>
										<div class="inside" id="fileuploaddiv">
                                                                                <?php if ($image_name != "") { ?>
                                                                                        <div>
												<b><?php echo __('imagem atual','full-width-responsive-slider-wp');?> : </b>
												<br/>
											...
											<div class="uploader">
												...
												<div style="clear: both; margin-top: 15px;"></div>
                                                                                                        <a
													href="javascript:;" class="niks_media" id="myMediaUploader_image"><b><?php echo __('clique aqui para upar a imagem','full-width-responsive-slider-wp');?></b></a>
                                                                                                    <br /> <br />
												<div>
												...
												<br />
                                                                        ...
                                                                        <div class="stuffbox" id="namediv" style="width: 100%">
										<h3>
											<label for="link_name"><?php echo __('titulo da imagem','full-width-responsive-slider-wp');?> 
											</label>
										</h3>
										<div class="inside">
											<div>
											...
											<div style="clear: both"></div>
                                                                       ...
                                                                       <div class="stuffbox" id="namediv" style="width:100%">
                                                                            <h3><label for="link_name"><?php echo __('descricao','full-width-responsive-slider-wp'); ?></label></h3>
                                                                            <div class="inside">
                                                                                <textarea cols="90" style="width:100%" rows="6" id="image_description" name="image_description"><?php echo $image_description; ?></textarea>
                                                                                <div style="clear:both"></div>
                                                                                <div></div>
                                                                                <div style="clear:both"></div>
                                                                                <p><?php _e('resumo de duas ou tres linhas do (MAXIMO)','full-width-responsive-slider-wp'); ?></p>
                                                                            </div>
                                                                        </div>
										...
										?>
                                                                            <?php wp_nonce_field('action_image_add_edit', 'add_edit_image_nonce'); ?>      
                                                                            <input type="submit"
										onclick="" name="btnsave" id="btnsave" value="<?php echo __('Salvar mudancas','full-width-responsive-slider-wp');?>"
										class="button-primary">&nbsp;&nbsp;<input type="button"
										name="cancle" id="cancle" value="<?php echo __('Cancelar','full-width-responsive-slider-wp');?>"
...
function fwrsw_responsive_full_width_slider_wp_media_preview_func(){
    ...
    <h2><?php echo __('Pre-visualizacao de imagen','full-width-responsive-slider-wp');?></h2>
    <br>
    ...
    <h3><?php echo __('para imprimir este controle deslizante no wordpress post/ page, use o codigo a baixo: ','full-width-responsive-slider-wp');?></h3>
    ...
    <div class="clear"></div>
    <h3><?php echo __('para imprimir este controle deslizante em arquivos php de tema / modelo do wordpress, use o código abaixo','full-width-responsive-slider-wp');?></h3>
    <?php
        $shortcode='[fwrsw_print_responsive_full_width_slider_wp]';
    ?>
